...
// Pause button functionality wip
...
// Write a pause function to run when user presses Space key
    function pausePlay() {
    }
...
Game over sound effect plays once this happens */
    ...
    function playerReset() {
        ...
        player.matrix = createPiece(pieces[pieces.length * Math.random() | Math.floor()]);
        player.pos.y = 0;
